...
<head>
    ...
    <title>sajib - personel portfolio</title>
    <!-- Favicon icon -->
	
	<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
	<link href="https://gitcdn.github.io/bootstrap-toggle/2.2.2/css/bootstrap-toggle.min.css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('uploads/admin') }}/{{ Auth::user()->logo }}">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route('dashboard') }}" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('uploads/admin') }}/{{ Auth::user()->logo }}" alt="">
                <img class="logo-compact" src="{{ asset('uploads/admin') }}/{{ Auth::user()->logo_text }}" alt="">
                <img class="brand-title" src="{{ asset('uploads/admin') }}/{{ Auth::user()->logo_text }}" alt="">
            </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="{{ route('mywork') }}">
							<i class="flaticon-381-heart"></i>
							<span class="nav-text">my work</span>
						</a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{ route('contact.info') }}">
				...
				<div class="copyright">
					<p><strong>Personal portfolio Admin Dashboard</strong> &copy; {{ carbon\carbon::now()->format('Y') }} All Rights Reserved</p>
					<p>Made with <span class="heart"></span> by Sjjib</p>
				</div>
			</div>
        </div>
        <!--**********************************
